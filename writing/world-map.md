# The World of Survive the 70s

> The fake Maryland the game is set in. **Old Bay County, MD** — a
> Baltimore-shaped fake county. Real geography compressed and renamed so
> places that were a 90-minute drive in real life can be a short ride in
> the game.

## The State: Maryland
Real Maryland, real-ish in shape. We just invent a new county between
Baltimore County and Anne Arundel and call it ours.

## The Setting: Old Bay County, MD
Population ~80,000 in 1979. Suburban sprawl northwest of the **Crab Cove**
(our fake Inner Harbor). Split-levels, ranchers, a creek behind every
third house, woods that go back farther than they should, and exactly one
of every kind of business — one mall, one arcade, one drive-in, one
liquor store with a guy out front.

---

## The Three Zones

### 🏠 Zone 1 — The Block (walking/biking)
Your home turf. Most of the demo lives here.
...
| **The Woods** | Goes back 200 yards to the railroad tracks. Forts, fires, a half-buried tire, a rumor of a body that never was. |
| **Quik-9** *(fake 7-Eleven)* | Corner store, 10-minute bike ride. Slurpee machine. Karen-equivalent behind the counter. Older kids smoke out back. |
| **The Bus Stop** | Where you wait for the bus during the school year. In summer, just a pole with a sticker on it. |

### 🌆 Zone 2 — The Town (longer bike ride)
The next ring out. Older stuff happens here.

| Place | Notes |
|---|---|
| **Hertzler's Mall** *(fake Hutzler's-style)* | Two-story enclosed mall. Department store anchor, food court (Orange Julius, Chick-fil-A's grandfather, soft pretzel cart). |
| **Sultan's Lair** *(fake Aladdin's Castle arcade)* | In the mall. Galaga, Asteroids, the *Super Star Adventures* pinball table that's always broken. |
| **The Cinerama** *(fake mall theater)* | One screen. Currently showing *Super Star Adventures II*. |
| **The High School** | The mythical place older siblings disappear to. |
...
### 🎢 Zone 3 — The Destinations (drives, weekends, summer)
Once-in-a-while special places. Each is its own potential scene.
...
| **The Cabin** | (optional) Family cabin somewhere in the mountains for fall weekends. |
| **Grandma's House** | (optional) Reachable by car. Cookie jar, plastic on the couches, *Lawrence Welk* on the TV. |

---

## Stomper's Rides (Ocean Side boardwalk)

> Our fake Trimper's. The single most important destination location in the
> game.

**What it is:** A boardwalk amusement park. Family-owned, slightly tired,
mostly amazing. Open since the 1920s. Each ride has a hand-painted sign
that's been touched up too many times.

**Headline ride: The Avalanche** — the Himalaya-style ride. Cars on a
circular track that swoop up and down over a fake mountain. Disco music
blasted at concert-cleric volume from cabinet speakers the size of
refrigerators. When the operator runs it *backward* at golden hour, with
Donna Summer's "Hot Stuff" playing, *that* is the most 1979 thing that
...
**The arcade attached to Stomper's:** Skee-ball, Galaga, change machine
that eats your money, the prize counter where 10,000 tickets gets you a
plastic comb.

---

## Ocean Side Boardwalk — Other establishments
...
(For when we eventually need a map.)
...
## TBD — for Mark's voice dump
- The Cast (kids, family, grown-ups) — see `cast.md` once we start
- Exact street names
- Little brother's name and age
- Best friend's real-or-chosen name
- The crush's name
- What's actually in the basement of the house
- Family pets
- Schools attended
- Church/synagogue if applicable
